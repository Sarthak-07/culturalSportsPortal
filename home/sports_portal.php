...
<nav class="navbar navbar-light navbar-expand-lg sticky-top navbar-mainbg">
    ...
    <form action="signin_user.php" method="post">
            ...
            <div class="form-group">
                <label>Name</label>
                <input type="text" class="form-control" placeholder="<?php echo $_SESSION['username']?>" name="name"  disabled>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="file" id="img" name="f" accept="image/png" onchange="validateImage()">
            </div>
            <div class="form-group">
                <button type="submit" class="btn btn-primary btn-block btn-lg" name="sign_in">Submit</button>
            </div>	
        </form>
